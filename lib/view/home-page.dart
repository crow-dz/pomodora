                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xff7650f6), width: 1.5)
                  ...
                  InkWell(
                    onTap: () {
                      if (timerCtr.isRunning.isFalse &&
                          timerCtr.currentSession.value <
                              timerCtr.session.length) {
                        if (!timerCtr.session[timerCtr.currentSession.value]
                            ['isDoneWork']) {
                          timerCtr.startTimer(
                              timerCtr.start.value, timerCtr.startRelax.value);
                        } else {
                          timerCtr.startTimer(timerCtr.startRelax.value,
                              timerCtr.startRelax.value);
                        }
                      } else {
                        timerCtr.stopTimer();
                      }
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(
                              color: const Color(0xff7650f6), width: 2)),
                      child: Container(
